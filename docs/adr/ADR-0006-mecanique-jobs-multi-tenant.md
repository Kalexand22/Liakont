...
provenance §4.13 et marqués `// Liakont addition (SOL06)` pour garder la re-convergence NuGet claire.
...
- `docs/architecture/provenance-socle-stratum.md` §4.4, §4.12, §4.13
