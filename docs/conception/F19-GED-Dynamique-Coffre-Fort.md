...
| D4 | **Périmètre V1** : MVP strict (coffre Liakont seul) ou coffre tiers dès V1 ? | Karl | MVP strict V1 ; coffre tiers fast-follow (dépend de D1) |
| D5 | **Pricing / positionnement** (upsell facturé séparément ? palier par tenant/volume/axe ?) | Karl | ❓ NON TRANCHÉ — feature-flag de **capacité tenant** (paramétrage en base), jamais coupler le code à une offre |
