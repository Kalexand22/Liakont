...
public sealed class PaPublicationConsoleServiceTests
{
    ...
    private sealed class RecordingPaClient : IPaClient
    {
        ...
        public Task<PaSendResult> SendDocumentAsync(Liakont.Agent.Contracts.Pivot.PivotDocumentDto document, bool sendAfterImport = true, PaOutboundProjection? projection = null, CancellationToken cancellationToken = default) =>
