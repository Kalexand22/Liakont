...
/// <summary>
/// Une ligne de facture Super PDP. Les montants viennent du pivot (déjà calculés par la source — le
/// plug-in ne calcule rien, F01-F02 §3.7), en <see cref="decimal"/> (CLAUDE.md n°1).
/// </summary>
internal sealed record SuperPdpInvoiceLine
{
    ...
    public SuperPdpTax? Tax { get; init; }
}
