...
public sealed record NormalizedAxisValue
{
    ...
    /// <summary>
    /// Valeur canonique pour tri / facette / recherche (casefold, ISO, decimal canonique). <see langword="null"/>
    /// pour un axe <c>json</c> (présentation-only, non facetté — INV-GED-04).
    /// </summary>
