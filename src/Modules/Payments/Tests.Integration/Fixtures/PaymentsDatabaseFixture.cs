namespace Liakont.Modules.Payments.Tests.Integration.Fixtures;
...
/// Payments. Partagé par la collection de tests d'intégration. La base unique du conteneur représente la
/// base DU TENANT (la connexion = le tenant — database-per-tenant, blueprint §7).
/// </summary>
public sealed class PaymentsDatabaseFixture : IAsyncLifetime
{
    ...
    private void RunModuleMigrations()
    {
        var upgrader = DeployChanges.To
            ...
            .WithScriptsEmbeddedInAssembly(
                Assembly.GetAssembly(typeof(PaymentsModuleRegistration))!,
