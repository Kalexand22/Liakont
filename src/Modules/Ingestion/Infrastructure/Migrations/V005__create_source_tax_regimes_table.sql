...
-- n°2 — aucune règle fiscale inventée). Upsert par (tenant_id, code) : occurrences cumulées, libellé
-- et horodatage rafraîchis. Consommé par TVA03 (détection de couverture : régime source non mappé).
