...
/// <summary>
/// Démarre un PostgreSQL jetable (Testcontainers) et applique les migrations communes (socle) puis celles du
/// module Reference. Le conteneur fait office de base SYSTÈME : <see cref="NpgsqlConnectionFactory"/> y ouvre
/// les connexions (il implémente <c>IConnectionFactory</c> ET <c>ISystemConnectionFactory</c>). Miroir de la
/// fixture d'Ingestion.
/// </summary>
public sealed class ReferenceDatabaseFixture : IAsyncLifetime
{
    ...
    private void RunModuleMigrations()
    {
        var upgrader = DeployChanges.To
            ...
            .WithScriptsEmbeddedInAssembly(
                Assembly.GetAssembly(typeof(ReferenceModuleRegistration))!,
