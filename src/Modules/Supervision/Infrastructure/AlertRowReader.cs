...
/// représentation CLR exacte que Npgsql renvoie pour <c>timestamptz</c>. Le libellé textuel
/// <c>severity</c> est restitué tel quel dans les DTO de lecture (fidélité à la base).
/// </summary>
internal static class AlertRowReader
{
