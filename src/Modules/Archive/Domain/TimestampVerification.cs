...
/// de chaîne attendue.
/// </summary>
/// <param name="IsValid">La preuve est valide et atteste bien l'empreinte attendue.</param>
...
public sealed record TimestampVerification(bool IsValid, DateTimeOffset? AnchoredUtc, string Detail);
