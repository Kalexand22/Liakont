...
/// <summary>
/// Ancrage OpenTimestamps (ancrage blockchain Bitcoin) — PRÉSENT mais NON OPÉRATIONNEL en V1 (ADR-0011).
...
/// produit de conformité fiscale. La décision (ADR-0011) le reporte en V1.1, RFC 3161 restant l'ancrage
...
public sealed class OpenTimestampsTimestampAnchor : ITimestampAnchor
{
    internal const string DeferredMessage =
        "L'ancrage OpenTimestamps est reporté en V1.1 (ADR-0011) : choisissez RFC 3161 (recommandé) ou NoAnchor. " +
