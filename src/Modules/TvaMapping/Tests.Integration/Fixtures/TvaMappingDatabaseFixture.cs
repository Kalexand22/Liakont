namespace Liakont.Modules.TvaMapping.Tests.Integration.Fixtures;
...
/// TvaMapping. Partagé par la collection de tests d'intégration.
/// </summary>
public sealed class TvaMappingDatabaseFixture : IAsyncLifetime
{
    ...
    private void RunModuleMigrations()
    {
        var upgrader = DeployChanges.To
            ...
            .WithScriptsEmbeddedInAssembly(
                Assembly.GetAssembly(typeof(TvaMappingModuleRegistration))!,
