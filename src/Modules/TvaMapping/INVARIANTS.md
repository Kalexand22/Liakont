...
| INV-TVAMAPPING-003 | Pas de doublon de règle sur le couple (code régime source, part). | `MappingTableValidator` (HashSet) + contrainte `uq_mapping_rules_regime_part` en base. |
