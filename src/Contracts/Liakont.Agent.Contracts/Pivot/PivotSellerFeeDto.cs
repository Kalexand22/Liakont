...
/// il transporte le terme extrait par la source (TTC en enchères, F03 §2.5 ; nature HT/TTC = paramétrage) (côté agent : <c>EncheresV6SellerFee</c>, B2C-07) au
...
public sealed class PivotSellerFeeDto
{
    ...
    /// </param>
    /// <param name="netAmount">Montant TTC du frais vendeur (nature TTC en enchères, F03 §2.5), en <c>decimal</c> (arrondi half-up par la source) — terme de la marge.</param>
    ...
    /// <summary>Montant TTC du frais vendeur (nature TTC en enchères, F03 §2.5), en <c>decimal</c> — terme de la formule de marge (B2C-09b).</summary>
