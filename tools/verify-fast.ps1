...
if ($ok) {
    $ok = Run-Step 'manifest-sanity' {
        ...
        # Lot names may contain digits (e.g. the FIX2 lot) — same charset as the $lots scan above,
        # else a lot like "FIX2" is truncated to "FIX" and reciprocity looks in the wrong lot file.
